...
[Jekyll](http://www.barryclark.co/introducing-jekyll-now/) is a GitHub repository/Jekyll theme by [Barry Clark](http://www.barryclark.co/) that can be cloned to instantly have a blog up and running with GitHub Pages free site hosting. 
...
I wrote an [article](https://sethlouis.dev/using-jekyll-and-github-on-mobile/) about how I often write and even publish posts using my phone and Jekyll. Jekyll Now, the specific theme I use, even includes built in support for setting up commenting using Disqus, the most popular blog commenting add on. 
